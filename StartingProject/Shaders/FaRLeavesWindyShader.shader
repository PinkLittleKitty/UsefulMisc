...
Shader "FaRTeam/FaRLeavesWindyShader" {
...
Properties {
    ...
    _ShakeDisplacement ("Desplazamiento", Range (0, 1.0)) = 1.0
    _ShakeTime ("Tiempo de sacudida", Range (0, 1.0)) = 1.0
    _ShakeWindspeed ("Velocidad del viento", Range (0, 1.0)) = 1.0
    _ShakeBending ("Deformación de sacudida", Range (0, 1.0)) = 1.0
}
